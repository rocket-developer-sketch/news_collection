package com.ddi.assessment.news.batch.job.google;
...
@Component
public class GoogleJobStrategy implements NewsJobStrategy {
    private final ApiStepFactory stepFactory;
    private final JobRepository jobRepository;
    private final JobExecutionListener jobLoggingListener;

    public GoogleJobStrategy(ApiStepFactory stepFactory,
